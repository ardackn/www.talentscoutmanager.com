  ...
  return (
    <div className="container min-h-screen py-24 max-w-4xl mx-auto px-6 text-slate-300">
      ...
      <div className="space-y-8 leading-relaxed font-dm">
        <section>
          <h2 className="text-2xl font-bold mb-4 text-white font-clash">{t('terms_section1_title')}</h2>
          <p>{t('terms_section1_content')}</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4 text-white font-clash">{t('terms_section2_title')}</h2>
          <p>{t('terms_section2_content')}</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4 text-white font-clash">{t('terms_section3_title')}</h2>
          <p>{t('terms_section3_content')}</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4 text-white font-clash">{t('terms_section4_title')}</h2>
