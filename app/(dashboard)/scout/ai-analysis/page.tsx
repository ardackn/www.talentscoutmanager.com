  ...
  return (
    <main className="container py-10 md:py-16 min-h-screen">
            ...
            <Card className="lg:col-span-1 relative overflow-hidden border-white/20 group">
              <CardContent className="p-8 md:p-12 text-center relative">
                <div className="relative mx-auto w-32 h-32 md:w-40 md:h-40 mb-6">
                  ...
                  />
                  <div 
                    className="absolute inset-4 md:inset-6 bg-gradient-to-r from-[#E94560] via-purple-600 to-[#E94560] rounded-full shadow-2xl animate-spin-slow [>*:nth-child(2)]:opacity-70 [>*:nth-child(3)]:opacity-30 transition-all group-hover:animate-spin-normal"
                    style={{
                      background: \`
                        conic-gradient(
                          #E94560 0deg \${(results.aiScore / 100) * 360}deg,
                          #4B4B63 \${(results.aiScore / 100) * 360}deg 360deg
                        )
                      \`
                    }}
                  />
      ...
      <style jsx>{`
        ...
        .animate-spin-normal {
          animation: spin-normal 20s linear infinite;
        }
      `}</style>
    </main>
  )
