      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00D26A]/10 border border-[#00D26A]/20 text-[#00D26A] font-bold text-sm mb-6">
            <FileText className="w-4 h-4" /> KULLANIM KOŞULLARI
          </div>
          ...
          <p className="text-xl text-gray-400 font-medium">
            TSM Platformu kullanım kuralları ve tarafların yasal sorumlulukları.
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 hover:border-[#00D26A]/30 transition-colors">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold">{t('terms_section1_title')}</h2>
            </div>
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 hover:border-[#00D26A]/30 transition-colors">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-bold">{t('terms_section2_title')}</h2>
            </div>
            <p className="text-gray-300 leading-relaxed text-lg mb-8">
              {t('terms_section2_content')}
            </p>
            <div className="p-4 rounded-2xl bg-yellow-500/10 border border-yellow-500/20 text-sm text-yellow-200/80 flex gap-3">
              <AlertCircle className="w-5 h-5 shrink-0" />
              <span>Analizler teknolojik verilere dayalıdır, kulüpler için bağlayıcı bir teklif değildir.</span>
            </div>
          </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <section className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-[#00D26A]/30 transition-colors">
              <h3 className="text-xl font-bold mb-4">{t('terms_section3_title')}</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                {t('terms_section3_content')}
              </p>
            </section>
            <section className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:border-[#00D26A]/30 transition-colors">
              <h3 className="text-xl font-bold mb-4">{t('terms_section4_title')}</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center text-sm text-gray-500">
          {t('last_updated')} {t('last_updated_date')} • <Link href="/privacy" className="hover:text-white transition-colors">Gizlilik Politikası</Link>
        </div>
      </div>
    </main>
  );
